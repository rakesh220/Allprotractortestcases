...
describe('one-to-one chat cases', function() {
    ...
    it('Send text messages to other users', function() {
     ...
     // element(by.id('userId74')).click();
      browser.driver.sleep(6000);
    element(by.xpath('//*[@id="Messages"]/div/div[3]/div[1]/input')).sendKeys("hi");
   browser.driver.sleep(6000);
   element(by.className('fa fa-telegram')).click();
   browser.driver.sleep(5000);
   element(by.xpath('//*[@id="Messages"]/div/div[3]/div[1]/input')).sendKeys("Welcome to Zapoj Application");
   browser.driver.sleep(6000);
   element(by.className('fa fa-telegram')).click();
 ...
 var path = require('path'),
    ...
    fileToUpload = "/home/rkondabala/All_Test_cases/one-to-one/sources/a.doc",
...
browser.driver.sleep(8000)
 ...
 var path = require('path'),
    uploadInput = element(by.css("input[type=file]")),
    fileToUpload = "/home/rkondabala/All_Test_cases/one-to-one/sources/b.png",
    absolutePath = path.resolve(__dirname, fileToUpload);
...
browser.driver.sleep(8000)
 ...
 var path = require('path'),
    uploadInput = element(by.css("input[type=file]")),
    fileToUpload = "/home/rkondabala/All_Test_cases/one-to-one/sources/c.flv",
    absolutePath = path.resolve(__dirname, fileToUpload);
...
browser.driver.sleep(8000)
    ...
    //0)user can see other user profile information
    it('user can see other user profile information', function() {
      ...
      browser.driver.sleep(5000);
      element(by.xpath('/html/body/aadhya-root/app-chat-page/div/div/div/div/div/aadhya-rightpanel/div/ul/li[5]/a/i')).click();
      browser.driver.sleep(5000);
      element(by.className('glyphicon glyphicon-pushpin')).click();
      browser.driver.sleep(5000);
   element(by.className('closeRt')).click();
    browser.driver.sleep(6000);
     ...
     it('Get typeing notification in chat', function() {
      element(by.xpath('//*[@id="Messages"]/div/div[3]/div[1]/input')).sendKeys("i am checking typeing notification");
      browser.driver.sleep(5000);
      element(by.xpath('//*[@id="Messages"]/div/div[3]/div[1]/input')).clear();
