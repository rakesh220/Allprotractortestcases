...
describe('one-to-one chat cases', function() {
   ...
   element(by.className('fa fa-telegram')).click();
    ...
    it('user can see other user profile information', function() {
      ...
      browser.driver.sleep(8000);
      element(by.xpath('/html/body/aadhya-root/app-chat-page/div/div/div/div/div/aadhya-group-right-panel/div/ul/li[3]/a')).click();
      browser.driver.sleep(5000);
      element(by.xpath('/html/body/aadhya-root/app-chat-page/div/div/div/div/div/aadhya-group-right-panel/div/ul/li[4]/a')).click();
